              ...
              <div class="box">
                <form action="">
                    <div class="box-header with-border">
                      <h3 class="box-title"> Bad Order Entry Form</h3>
                        ...
                        <div class="form-group pull-right">
                          ...
                          <div class="col-lg-5 input-group">
                              <span class="input-group-btn">
                                <button class="btn btn-info" type="button">Save and Add Another</button>
                              </span>
                          </div><!-- /input-group -->
                          
                          <div class="col-lg-5 input-group">
                              <span class="input-group-btn">
                                <button class="btn btn-info" type="button">Save and View Bad Orders</button>
                              </span>
                          </div><!-- /input-group -->
