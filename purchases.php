            ...
            <div class="box-body">
              ...
              if (isset($_POST['submit'])) {
                ...
                while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
                  if ($ctr == 0) {
                    ...
                    $data3 = array(
                      'qty_delivered' => 'qty_delivered + ' . $data[3],
                      'actual_count' => 'actual_count + ' . $data[3]
                      );

                    if ($db->update("tbl_product", $data3 , "WHERE prod_no = ".$data[0])) {
                    }
                    else 
                      Session::flash('msg', "Error accessing product records.");
                ...
                print "\n\nImport completed.";
                echo "<br><h3><a href='purchases.php' class='btn btn-info'>Upload another file</a></h3>";
              ...
              ?>
                  ...
                  <div class="form-group ">
                    ...
                    <input required value="<?php echo Input::get('ref_date') ?  Input::get('ref_date') : ''; ?>"  name="ref_date"  type="date" class="form-control datepicker" id="" placeholder="">
                  </div>
