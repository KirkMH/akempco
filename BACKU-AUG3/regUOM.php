            ...
            <div class="col-md-12">
                ...
                <form action="/akempco/includes/processor.php?<?php echo Input::get('uom_no') ?  "action=update" : "" ?>" method="GET">
                  <input class="button orange" type='hidden' name='token' value="<?php echo $token; ?>" />
                    <div class="box-header with-border">
                      <h3 class="box-title"><?php echo Input::get('uom_no') ?  "Update Unit of Measure" : "Add New Unit of Measure"; ?> </h3>
                    ...
                    <div class="box-body">
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <input name="action" value="<?php echo Input::get('uom_no') ?  'update' : 'insert'; ?>"  type="hidden">
                            <input name="dataID" value="<?php echo Input::get('uom_no') ?  Input::get('uom_no') : ''; ?>"  type="hidden">
                            <input name="filter" value="<?php echo Input::get('uom_no') ?  'uom_no' : ''; ?>"  type="hidden">
                            <input name="table" value="<?php echo $table; ?>" type="hidden">
                            <div class="form-group ">
                              <label>Unit of Measure</label>
                              <input value="<?php echo Input::get('uom_name') ?>" type="text" class="form-control" name="uom_name" placeholder="">
                            </div>
                            
                            <div class="form-group ">
                              <label>Unit of Measure Description</label>
                              <input value="<?php echo Input::get('uom_desc') ?>" type="text" class="form-control" name="uom_desc" placeholder="">
                            </div>
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Registered Department</h3>
                  <div class="box-tools pull-right">
                    <button data-widget="collapse" class="btn btn-box-tool"><i class="fa fa-minus"></i></button>
                  </div>
                </div><!-- /.box-header -->
                        ...
                        while ($dataAttri = $sqlResult->fetch_assoc()) {
                          ...
                          <tr>
                            <td> <a href="/akempco/includes/processor.php?action=select&page=<?php echo basename($_SERVER['PHP_SELF']); ?>&table=<?php echo $table; ?>&filter=<?php echo $filter; ?>&dataID=<?php echo $dataID; ?> ">UPDATE</a> |
                               <a href="/akempco/includes/processor.php?action=update&page=<?php echo basename($_SERVER['PHP_SELF']); ?>&table=<?php echo $table; ?>&filter=<?php echo $filter; ?>&dataID=<?php echo $dataID; ?>&active=">DELIST</a></td>
                             <td><?php echo ucfirst($dataAttri['uom_name']);?></td>
                             <td><?php echo ucfirst($dataAttri['uom_desc']);?></td>
