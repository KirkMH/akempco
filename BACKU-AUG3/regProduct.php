  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
                  ...
                  <?php 
                  // if(Session::exists('processor_result')){
                  //   echo "<h3>" . Session::flash('processor_result') ." </h3>";
                  // }
                   ?>           

        <!-- Default box -->
        <div class="box">
          <form action="/akempco/includes/processor.php?<?php echo Input::get('prod_no') ?  "action=update" : ""; ?>;" method="GET">
...
-->
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group ">
                    ...
                    <input required value="<?php echo Input::get('srpice') ?  Input::get('srprice') : ''; ?>"  name="srprice"  type="text" class="form-control" id="" placeholder="" maxlength="15">
                  </div>

                  <div class="form-group ">
                    <label>Number of Items in Wholesale</label>
                    <input required value="<?php echo Input::get('numWholesale') ?  Input::get('numWholesale') : ''; ?>"  name="numWholesale"  type="text" class="form-control" id="" placeholder="" maxlength="15">
                  </div>
