        ...
        <section class="content">
          <div class="row">
            <div class="col-md-12">
              ...
              <!-- Default box -->
              <div class="box">
                <form action="/akempco/includes/processor.php?<?php echo Input::get('disc_no') ?  "action=update" : "" ?>" method="GET">
                  <input class="button orange" type='hidden' name='token' value="<?php echo $token; ?>" />
                    <div class="box-header with-border">
                      <h3 class="box-title"><?php echo Input::get('disc_no') ?  "Update Discount" : "Add New Discount"; ?> </h3>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control" name="lessVAT">
                                <!-- <option >Select Status</option> -->
                                <option <?php echo Input::get('lessVAT') == '1' ? 'selected="selected"' : '' ?> value="1" >Yes</option>
                                <option <?php echo Input::get('lessVAT') == '0' ? 'selected="selected"' : '' ?> value="0" >No</option>
                              </select>
                            </div> 
                        ...
                        while ($dataAttri = $sqlResult->fetch_assoc()) {
                          ...
                          <tr>
                            <td> <a href="/akempco/includes/processor.php?action=select&page=<?php echo basename($_SERVER['PHP_SELF']); ?>&table=<?php echo $table; ?>&filter=<?php echo $filter; ?>&dataID=<?php echo $dataID; ?> ">UPDATE</a> |
                             ...
                             <td align='right'><?php echo $dataAttri['percentage'];?>%</td>
