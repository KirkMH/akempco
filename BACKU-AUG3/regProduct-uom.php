...
$sqlResult = $db->select('*', "tbl_productprice",  "WHERE prod_no=" . Input::get('dataID'));
                ...
                ?>
                  <tr>
                    ...
                    <a href="/akempco/includes/processor.php?action=update&page=<?php echo basename($_SERVER['PHP_SELF']); ?>&table=<?php echo $table; ?>&<?php echo $filter; ?>&dataID=<?php echo $dataAttri['prod_no']; ?>&active=">DELIST</a></td>
